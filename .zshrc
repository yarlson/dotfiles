...
# Base configuration (environment, tools, completion, prompt)
...
[[ -f ~/.config/zsh/worktrees.zsh ]] && source ~/.config/zsh/worktrees.zsh
[[ -f ~/.config/zsh/tmux-layout.zsh ]] && source ~/.config/zsh/tmux-layout.zsh
